""" функции анализируют последовательности символов в строке
и подсчитывают количество пар, набранных левой или правой рукой,
либо "удобные" пары, сформированные из символов, 
расположенных в соседних рядах клавиатуры"""
def check_h2_qwerty(strs):
    """cчитает любые пары, набранные одной рукой"""
...
""" находит одну пару которая сформирована в результате перехода с одного ряда на другой"""
