"""функции предназначены для анализа текста, введенного на клавиатуре,
и определения частоты использования комбинаций символов, которые набираются
одной рукой или более удобными сочетаниями для раскладки Зубачева.""" 
def check_h3_zubachew(strs):
    """находит две тройки, набранные одной рукой."""
...
def check_h3_zubachew_com(strs):
    """находит две "удобные" комбинации"""
