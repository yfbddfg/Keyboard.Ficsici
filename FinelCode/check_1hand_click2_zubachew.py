"""функции анализируют строки на предмет последовательностей символов, набираемых одной рукой"""
def check_1hand_click2_zubachew(strs):
    """ функция анализирует строку и считает, сколько раз подряд
    встречаются две буквы, которые обычно набираются одной и той же рукой """
...
def check_1hand_click2_zubachew_comfortable(strs):
    """ функция анализирует строку и подсчитывает более "комфортные"
    комбинации из двух символов подряд, набираемые одной и той же рукой"""
